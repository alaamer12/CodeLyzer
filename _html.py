...
class HTMLReportGenerator:
    ...
    def __init__(self):
        ...
        self._chart_options = self._get_chart_options()
...
<body>
    <div class="container">
        ...
        {self._generate_metrics_grid()}
        {self._generate_charts_grid()}
        {self._generate_tables_grid()}
    </div>
    <script>
    ...
    def _generate_head(self) -> str:
        """Generate the HTML head section with meta tags, title, and styles"""
        return f'''<head>
    <meta charset="UTF-8">
    ...
    def _get_base_styles(self) -> str:
        """Generate base CSS styles for fundamental elements"""
        return '''
        * { 
            margin: 0; 
            padding: 0; 
    ...
    def _get_component_styles(self) -> str:
        ...
        {self._get_metric_card_styles()}
        {self._get_chart_styles()}
        {self._get_table_styles()}
        {self._get_utility_styles()}
        '''
    ...
    def _get_metric_card_styles(self) -> str:
        """Generate metric card component styles"""
        return '''
        .metric-card { 
            background: white; 
            padding: 28px; 
    ...
    def _get_chart_styles(self) -> str:
        """Generate chart component styles"""
        return '''
        .chart-container { 
            background: white; 
            padding: 32px; 
    ...
    def _get_table_styles(self) -> str:
        """Generate table component styles"""
        return '''
        .table-container { 
            background: white; 
            border-radius: 12px; 
    ...
    def _get_utility_styles(self) -> str:
    ...
    def _generate_header(self) -> str:
        """Generate the page header section"""
        return """
        <div class="header">
    ...
    def _generate_metrics_grid(self) -> str:
        ...
        <div class="metrics-grid fade-in">
            {self._generate_metric_card("files", "fa-file-code", "Files Analyzed", "{{total_files:,}}")}
            {self._generate_metric_card("code", "fa-code", "Lines of Code", "{{total_loc:,}}")}
            {self._generate_metric_card("classes", "fa-cube", "Classes", "{{total_classes:,}}")}
            {self._generate_metric_card("functions", "fa-cogs", "Functions", "{{total_functions:,}}")}
            {self._generate_metric_card("quality", "fa-star", "Code Quality", "{{code_quality:.1f}}%")}
            {self._generate_metric_card("maintainability", "fa-tools", "Maintainability", "{{maintainability:.1f}}%")}
        </div>"""
    
    def _generate_metric_card(self, icon_class: str, icon_name: str, label: str, value: str) -> str:
        """Generate a single metric card"""
        return f'''
            <div class="metric-card">
                <div class="metric-header">
                    <div class="metric-icon {icon_class}"><i class="fas {icon_name}"></i></div>
                </div>
    ...
    def _generate_charts_grid(self) -> str:
        """Generate the charts grid section"""
        return '''
    ...
    def _generate_tables_grid(self) -> str:
        """Generate the tables grid section"""
        return f'''
        <div class="tables-grid fade-in">
            {self._generate_table_container("Most Complex Files", "fa-fire", self._get_complex_files_table())}
            {self._generate_table_container("Top Dependencies", "fa-box", self._get_dependencies_table())}
        </div>'''
    
    def _generate_table_container(self, title: str, icon: str, table_content: str) -> str:
        """Generate a table container with header"""
        return f'''
    ...
    def _get_complex_files_table(self) -> str:
        """Generate the complex files table"""
        return """
                    <table>
                        <thead>
                            <tr>
    ...
    def _get_dependencies_table(self) -> str:
    ...
    def _get_chart_options(self) -> str:
    ...
    <script>
        ...
        {self._generate_language_chart()}
        {self._generate_complexity_chart()}
        {self._generate_dom_ready_script()}
    </script>'''
    
    def _generate_language_chart(self) -> str:
        """Generate language distribution chart JavaScript"""
        return """
    ...
    def _generate_complexity_chart(self) -> str:
        """Generate complexity distribution chart JavaScript"""
        return """
    ...
    def _generate_dom_ready_script(self) -> str:
        """Generate DOM ready JavaScript for animations"""
        return '''
